...
class POVendor(models.Model):
    """
    Vendor data for Purchase Orders
    """
    name = models.CharField(max_length=100)
    contact_person = models.CharField(max_length=100, blank=True, null=True)
    phone_number = models.CharField(max_length=20, blank=True, null=True)
...
# Keep the old Vendor model for backward compatibility during migration
class Vendor(models.Model):
    """
    Legacy vendor model - will be removed after migration
    """
    name = models.CharField(max_length=100, unique=True)
    contact_person = models.CharField(max_length=100, blank=True, null=True)
    phone_number = models.CharField(max_length=20, blank=True, null=True)
...
class WorkOrder(models.Model):
    ...
    vendor = models.ForeignKey(WOVendor, on_delete=models.CASCADE, related_name='work_orders')
...
class PurchaseOrder(models.Model):
    ...
    vendor = models.ForeignKey(POVendor, on_delete=models.CASCADE, related_name='purchase_orders')
